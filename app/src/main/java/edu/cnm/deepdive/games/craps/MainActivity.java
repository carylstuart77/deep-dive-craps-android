    ...
    ((Button)findViewById(R.id.playButton)).setOnClickListener(new OnClickListener() {
      ...
      public void onClick(View view) {
       ...
       game.play();
        ...
        ((TextView) findViewById(R.id.tallyView)).setText (
            String.format(getString(R.string.tally_message), game.getWins(),
            game.getLosses(), 100.0 * game.getWins() / game.getPlays()));
      }
    });
  }
}
