...
public class Game {
  ...
  public void roll() {
    // bail out if you are in a WIN or Lose state
    if (state != State.COME_OUT && state != State.POINT) {
      return;
    }
    //roll dice and set state of roll
  ...
  public class Roll {
    ...
    public String toString() {
      return String.format(context.getString(edu.cnm.deepdive.games.craps.R.string.dice_roll_message),
